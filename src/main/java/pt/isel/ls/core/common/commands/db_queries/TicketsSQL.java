...
public class TicketsSQL {
     ...
     * @throws SQLException SQLException
     */
    public static boolean deleteTicket(Connection con, String sessionID, List<String> ticketsIDs, int numberOfTickets) throws SQLException {
     ...
     * @throws SQLException SQLException
     */
    public static Map<String, Ticket> queryAll(Connection con, String sessionID) throws SQLException {
        PreparedStatement stmt = con.prepareStatement(
        ...
        Ticket ticket;
        while(rs.next()){
            ticket = new Ticket(rs.getString(1).charAt(0), rs.getInt(2), rs.getString(3));
     ...
     * @throws SQLException SQLException
     */
    public static Ticket queryID(Connection con, String sessionID, String ticketID) throws SQLException {
        PreparedStatement stmt = con.prepareStatement(
                "SELECT tk.row, tk.seat, s.sid " +
                "FROM TICKET AS tk " +
                "INNER JOIN CINEMA_SESSION AS s ON tk.sid=s.sid " +
        ...
        return new Ticket(rs.getString(1).charAt(0), rs.getInt(2), rs.getString(3));
    }
}
