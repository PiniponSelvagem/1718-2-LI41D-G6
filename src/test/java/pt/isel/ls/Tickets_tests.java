...
public class Tickets_tests {
    ...
    public void createTickets(Connection con) {
        try {
            ...
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[0] + "/sessions/" + sessionsId[0]+"/tickets","seat=1&row=a"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[0] + "/sessions/" + sessionsId[1]+"/tickets","seat=2&row=b"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[0] + "/sessions/" + sessionsId[2]+"/tickets","seat=3&row=c"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[1] + "/sessions/" + sessionsId[3]+"/tickets","seat=4&row=d"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[1] + "/sessions/" + sessionsId[4]+"/tickets","seat=5&row=e"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[1] + "/sessions/" + sessionsId[5]+"/tickets","seat=6&row=f"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[0] + "/sessions/" + sessionsId[1]+"/tickets","seat=3&row=b"}, new CommandUtils()));
            Main.executeBuildedCommand(con, new CommandBuilder(new String[]{"POST", "/cinemas/" + cinemaId + "/theaters/" + theatersId[1] + "/sessions/" + sessionsId[4]+"/tickets","seat=6&row=e"}, new CommandUtils()));
